    ...
    if(position.isValid()){
        ...
        if(center_position.isValid()){
            ...
            if(game.board[center_index].type == PIECES.empty)
                moves.push(new Move(game.board[index],position,center_position,game.board[center_index], center_position));
        }
        if(double_position.isValid())
        {
            ...
            if(game.board[double_index].type == PIECES.empty && game.board[center_index].type == PIECES.empty && canPawnDouble(position,game.board[index]))
                moves.push(new Move(game.board[index],position, double_position, game.board[double_index], double_position));
        }
        if(left_position.isValid())
        {
            ...
            if (enpassant_condition)
                moves.push(new Move(game.board[index],position,left_position,game.board[prev_index],prev_position));
        }
        if(right_position.isValid())
        {
            ...
            if (enpassant_condition)
                moves.push(new Move(game.board[index],position,right_position,game.board[prev_index],prev_position));   
        }
